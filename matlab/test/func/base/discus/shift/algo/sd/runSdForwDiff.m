...
% nohup matlab -nodesktop -nodisplay -nosplash <runSdForwDiff.m >runSdForwDiff.out 2>&1 &
...
% first put runSdForwDiff.m in the working directory of the `minFunc` library
addpath(genpath(pwd));
...
save('runSdForwDiff.mat', 'optRes', 'funcDims', '-v7.3');
