...
% nohup matlab -nodesktop -nodisplay -nosplash <runSdCentDiff.m >runSdCentDiff.out 2>&1 &
...
% first put runSdCentDiff.m in the working directory of the `minFunc` library
addpath(genpath(pwd));
...
save('runSdCentDiff.mat', 'optRes', 'funcDims', '-v7.3');
