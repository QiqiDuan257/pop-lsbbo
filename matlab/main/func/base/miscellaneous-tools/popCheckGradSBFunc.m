function popCheckGradSBFunc(funcName, X, G, tol)
% Check the Gradient of Shifted Base Function via test cases.
%
% Input ->
...
for t = 1 : popSize
    ...
    if ~popCheckIsClose(feval(funcName, XX), G(:, t), tol) || ...
            ~popCheckIsClose(feval(funcName, XX'), G(:, t)', tol)
